...
public class ListAdapter<T> extends BaseAdapter implements Filterable {
     ...
     */
    public ListAdapter(Context context, List<T> dataItems, int layoutResource,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (null == v) {
            ...
            ListAdapterUtils.initViews(v, holder, mBindDictionary);
    ...
    private void showData(T item, GenericViewHolder holder, int position) {
        ...
        ListAdapterUtils.showData(item, holder, position, mBindDictionary);
    }

    public ListAdapter<T> setAlternatingBackground(int oddColorRes, int evenColorRes) {
