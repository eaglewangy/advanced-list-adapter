...
import com.peony.listadapter.extractors.ChildExtractor;
...
public class ExpandableFunDapter<G, C> extends BaseExpandableListAdapter {
    ...
    private void showGroupData(G item, GenericViewHolder holder, int position) {
        ...
        ListAdapterUtils.showData(item, holder, position, mGroupDictionary);
    }
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView,
        ...
        if (null == v) {
            ...
            ListAdapterUtils.initViews(v, holder, mGroupDictionary);
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild,
        ...
        if (null == v) {
            ...
            // init the sub views and put them in a holder instance
            ListAdapterUtils.initViews(v, holder, mChildDictionary);
        ...
        ListAdapterUtils.showData(item, holder, groupPosition, mChildDictionary);
