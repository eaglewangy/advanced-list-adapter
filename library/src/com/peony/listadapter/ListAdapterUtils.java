...
import com.peony.listadapter.fields.BaseField;
import com.peony.listadapter.fields.CheckableField;
import com.peony.listadapter.fields.ConditionalVisibilityField;
import com.peony.listadapter.fields.DynamicImageField;
import com.peony.listadapter.fields.ProgressBarField;
import com.peony.listadapter.fields.StaticImageField;
import com.peony.listadapter.fields.StringField;
...
public class ListAdapterUtils {
    ...
    private static <T> void handleStringFields(T item, GenericViewHolder holder, int position,
        ...
        for (int i = 0; i < dictionary.getStringFields().size(); i++) {
            ...
            if (field.backgroundEntry != null) {
                String color = field.backgroundEntry.getStringValue(item, position);
